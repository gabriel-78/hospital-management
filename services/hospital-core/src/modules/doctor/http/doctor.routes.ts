...
import { CachedDoctorRepository } from '../infra/cached-doctor.repository.js';
import {
  CreateDoctorUseCase,
  DeleteDoctorUseCase,
...
const repository = new CachedDoctorRepository(new PrismaDoctorRepository(), new RedisCacheProvider());
